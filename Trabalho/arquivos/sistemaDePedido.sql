...
CREATE TABLE `tb_itenspedido` (
  ...
  KEY `FK750juiq4ml9dv8tfceoxc492v` (`item`),
  CONSTRAINT `FK750juiq4ml9dv8tfceoxc492v` FOREIGN KEY (`item`) REFERENCES `tb_itens` (`codItem`),
...
INSERT INTO `tb_itenspedido` (`codItemPedido`, `quantidade`, `pedido`, `item`) VALUES (1,2,1,3),(2,3,1,4),(3,2,2,2),(4,2,2,5),(5,4,3,1),(6,2,3,2),(7,3,4,5),(8,2,4,3),(9,2,5,4),(10,2,5,1);
...
INSERT INTO `tb_itens` (`codItem`, `nome`, `preco`) VALUES (1,'Teclado',30.00),(2,'Mouse',20.00),(3,'Placa de Video GTX 980',1200.00),(4,'Monitor LG 24 pol',600.00),(5,'Zenfone 2 Laser',850.00);
